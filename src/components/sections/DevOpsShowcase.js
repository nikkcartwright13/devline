...
import DevOpsMockup from "../ui/DevOpsMockup";
import Icon from "../ui/Icon";
import { upperLabel } from "../../lib/text";

const STACK = ["GitLab CI/CD", "GitHub Actions", "Docker", "Kubernetes", "Datadog"];

export default function DevOpsShowcase() {
  const { t } = useTranslation();
  const features = t("devops.features", { returnObjects: true });
