...
import DesignMockup from "../ui/DesignMockup";
import Icon from "../ui/Icon";
import { upperLabel } from "../../lib/text";

const STACK = ["Figma", "Figma Dev Mode", "FigJam"];

export default function FigmaShowcase() {
  const { t } = useTranslation();
  const features = t("figma.features", { returnObjects: true });
