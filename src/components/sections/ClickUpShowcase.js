...
import ClickUpMockup from "../ui/ClickUpMockup";
import Icon from "../ui/Icon";
import { upperLabel } from "../../lib/text";

const STACK = ["ClickUp", "Zapier", "Slack", "GitHub"];

export default function ClickUpShowcase() {
  const { t } = useTranslation();
  const features = t("clickup.features", { returnObjects: true });
        ...
        <Reveal>
          ...
          <div style={{ marginTop: 28 }}>
            <p style={{ ...mono, fontSize: 11.5, letterSpacing: ".1em", color: "#93A5CE" }}>
              {upperLabel(t("clickup.builtWith"))}
            </p>
